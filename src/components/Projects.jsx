...
function Projects() {
    ...
    return (
        ...
        className='container mx-auto p-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
            <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>Website Projects </h1>
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>what I have worked on and what I am capable of doing.</p>
